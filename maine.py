...
@app.post('/create')
def create_patient(patient: Patiant):
...
def update_patient(patient_id: str, patient_update: PatiantUpdate):
    ...
    # FIX: Normalize gender from EXISTING data (could be old lowercase data)
    # This handles both old data and new updates
    ...
    # Add id BEFORE creating Patient
    patient_dict = {
        "id": patient_id,
